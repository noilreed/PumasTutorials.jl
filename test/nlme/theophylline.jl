...
@testset "run2.mod FO without interaction, diagonal omega and additive error" begin
  ...
  rng = StableRNG(12349)
  bts = bootstrap(o_boot; samples=5, rng=rng)
  @test evaluate(
    Levenshtein(),
...
-------------------------------------------------------------------
θ₁         4.0491          0.25441          [ 3.5118  ;  4.1002  ]
θ₂         0.074816        0.0045667        [ 0.070167;  0.079591]
θ₃         0.036284        0.0026572        [ 0.033818;  0.038876]
θ₄         2.0844          0.41044          [ 1.6062  ;  2.5942  ]
Ω₁,₁      14.836           3.7617           [10.075   ; 18.054   ]
Ω₂,₂       0.19727         0.079014         [ 0.12612 ;  0.29249 ]
σ²_add     0.35574         0.081197         [ 0.17502 ;  0.36662 ]
-------------------------------------------------------------------
...
""") < 3 # allow three characters to differ
  ...
  rng = StableRNG(12349)
  bts = bootstrap(o_boot; samples=5, stratify_by=:SEX, rng=rng)
  @test evaluate(
    Levenshtein(),
    sprint((io, t) -> show(io, MIME"text/plain"(), t), bts),
"""
...
-------------------------------------------------------------------
          Estimate           SE                     95.0% C.I.
-------------------------------------------------------------------
θ₁         4.0491          0.27407          [ 3.6438  ;  4.2168  ]
θ₂         0.074816        0.0063687        [ 0.068528;  0.083684]
θ₃         0.036284        0.0037537        [ 0.031862;  0.040339]
θ₄         2.0844          0.70534          [ 0.94315 ;  2.6618  ]
Ω₁,₁      14.836           4.55             [10.735   ; 19.616   ]
Ω₂,₂       0.19727         0.072744         [ 0.082219;  0.2669  ]
σ²_add     0.35574         0.031147         [ 0.29276 ;  0.36836 ]
-------------------------------------------------------------------
Successful fits: 5 out of 5
