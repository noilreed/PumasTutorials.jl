...
export @model, @nca
export infer, inspect, vpc, lrtest, pvalue, probstable, icoef
...
# From StatsBase
export aic, bic, coef, coeftable, loglikelihood, fit, informationmatrix, predict, stderror, vcov, bootstrap
...
function print_license()
    ...
    print(   """Pumas.jl is a proprietary package. It is free to use for non-commercial
...
(https://juliacomputing.com/eula) for details. Please contact sales@juliacomputing.com
for purchase.
""")
end
print_license()
