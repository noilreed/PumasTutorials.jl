...
@inline function LinearAlgebra.eigen(::Central1Periph1Meta1Periph1, p)
  ...
  m′ = Central1Periph1()
  Λ = vcat(_Λ(m′, a+d, b, c),  _Λ(m′, e, f, h))
  ...
  v4_3 = (Λ[4] + h)/f
  # first row
  v1_1 = (Λ[1] + ϕ) * v1_3/d - h/d
  v2_1 = (Λ[2] + ϕ) * v2_3/d - h/d

  # second row
  v1_2 = ((c - ϕ)*Λ[2] + c*(b + c - ϕ))*v1_3/(c*d) + h*(Λ[2] + c)/(c*d)
  v2_2 = ((c - ϕ)*Λ[1] + c*(b + c - ϕ))*v2_3/(c*d) + h*(Λ[1] + c)/(c*d)
